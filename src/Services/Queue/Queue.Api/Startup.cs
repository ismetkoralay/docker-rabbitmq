        ...
        public void ConfigureServices(IServiceCollection services)
        {
            services.AddControllers()
                .AddFluentValidation(x =>
                    x.RegisterValidatorsFromAssemblyContaining(typeof(SendMessageRequestModelValidator)))
            ...
            services.AddSwaggerGen(c => { c.SwaggerDoc("v1", new OpenApiInfo {Title = "Queue.Api", Version = "v1"}); });
